...
const API_URL = `http://demo.thingsboard.io/api/plugins/telemetry/DEVICE/${DEVICE_ID}/values/timeseries?keys=state,soil_moisture,ldr_value,water_level`;
...
export const fetchDeviceDataAPI = async () => {
  ...
  return {
    ...
    soil_moisture: response.data.soil_moisture[0].value,
